...
Make sure the custom resolver implements [`ApiPlatform\Core\Operation\PathSegmentNameGeneratorInterface`](https://github.com/api-platform/core/blob/master/src/Operation/PathSegmentNameGeneratorInterface.php):
...
class SingularPathSegmentNameGenerator implements PathSegmentNameGeneratorInterface
{
    ...
    public function getSegmentName(string $name, bool $collection = true): string
    {
        ...
        // BUG: Why $collection is always true?
        return $name;
    }
